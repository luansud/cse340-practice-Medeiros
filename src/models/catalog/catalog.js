...
// Functions to retrieve All courses
const getAllCourses = () => {
    return courses;
};
...
// Function to sort sections based on a given criteria (time, professor, room)
...
// Function to get courses grouped by department
...
// Exporting the model functions for use in controllers
